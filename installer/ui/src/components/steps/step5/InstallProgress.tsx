...
export function InstallProgress() {
  ...
  useEffect(() => {
    if (!hasStarted && state.installationProgress.length === 0) {
      setHasStarted(true);
      startInstallation();
    }
  }, [hasStarted, state.installationProgress.length, startInstallation]);
    ...
    <div className="mx-auto max-w-4xl space-y-8">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-white">
          {isComplete ? "Installation Complete!" : "Installing Components"}
        </h2>
